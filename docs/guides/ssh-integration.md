...
**Planned Features** (see [specs/missing-features/node-operations/](../../specs/missing-features/node-operations/)):
- SCP file transfer integration ([file-transfer.md](../../specs/missing-features/node-operations/file-transfer.md))
- RSYNC synchronization ([file-transfer.md](../../specs/missing-features/node-operations/file-transfer.md))
- SSH automation script templates ([ssh-automation.md](../../specs/missing-features/node-operations/ssh-automation.md))
...
For upcoming SSH features, see the specifications in `/specs/missing-features/node-operations/`:

- **File Transfer** ([file-transfer.md](../../specs/missing-features/node-operations/file-transfer.md))
  - SCP file upload/download
  - RSYNC synchronization
  - Progress tracking
  - Multi-node transfers

- **SSH Automation** ([ssh-automation.md](../../specs/missing-features/node-operations/ssh-automation.md))
  - Reusable script templates
  - Parameterized commands
  - Multi-node batch operations
  - Diagnostic script library

These features will be added in future releases to enhance S9S's node management capabilities.
